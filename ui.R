...
#                              showOutput("chartcu", "highcharts"), 
#                              showOutput("chartco", "highcharts"), 
#                              showOutput("chartcl", "highcharts")
                             )
                   
#                      tabPanel("3D Plot", 
#                               div(class = "row",
#                                   div("Cut", showOutput("myChart", "nvd3"), class = "span3"),
#                                   div(class='span3'),
#                                   div("Color", showOutput("myChart2", "nvd3"), class = "span3")
#                               ),
#                               div(class = "row",
#                                   div(class="span3"),
#                                   div("Clarity", showOutput("myChart3", "nvd3"), class = "span4"),
#                                   div(class="span3")
#                               )
#                               )
